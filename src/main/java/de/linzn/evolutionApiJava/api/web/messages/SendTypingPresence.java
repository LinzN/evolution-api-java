...
public class SendTypingPresence {
    ...
    private SendTypingPresence(WebClient webClient, String instanceName, JidClient receiverClientId, int delay) {
    ...
    public static SendTypingPresence builder(WebClient webClient, String instanceName, JidClient receiverClientId, int delay) {
        return new SendTypingPresence(webClient, instanceName, receiverClientId, delay).call();
    }
